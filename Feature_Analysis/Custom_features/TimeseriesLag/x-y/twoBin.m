...
% -------------------------------------------------------------------------
    ...
    out.alt_corr_equiv = std(res_eq(2, :)).*(1./std(upperes(1, :)) - 1./std(loweres(1, :)));%
    %----------------------------------------------------------------------
    ...
    out.logdiffequiv = std(res_eq(2, :)).*(log(std(upperes_eq(1, :))) - log(std(loweres_eq(1, :))));%std(res_eq(2, :)).*(log(uv) - log(lv));%
    out.loggrad = out.logdiffequiv./(mean(upperes_eq(1, :)) - mean(loweres_eq(1, :)));%
