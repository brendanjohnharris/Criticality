    ...
    switch system
        ...
        case 'supercritical_pitchfork_(strogatz)'
            inputs = make_input_struct(0, 'cp_range', -1:0.01:0, 'etarange', 0.01:0.01:1, ...
                ...
                'tmax', 1000, 'T', 500, 'save_cp_split', save_cp_split, ...
                'randomise', 0, 'rngseed', 28012024, 'vocal', 1);

        case 'supercritical_hopf_radius_(strogatz)_pink'
            inputs = make_input_struct(0, 'cp_range', -1:0.01:0, 'etarange', 0.005:0.005:0.5, ...
                'bifurcation_point', 0, 'initial_conditions', 0, ...
                'foldername', fullfile(outfolder, 'results'), 'numpoints', 1000000, ...
                'parameters', [], 'savelength', 5000, ...
                'system_type', 'supercritical_hopf_radius_(strogatz)_pink', ...
                'tmax', 1000, 'T', 500, 'save_cp_split', save_cp_split, ...
                'randomise', 0, 'rngseed', 25012024, 'vocal', 1);
        ...
        case 'supercritical_hopf_radius_(strogatz)_brownian'
            inputs = make_input_struct(0, 'cp_range', -1:0.01:0, 'etarange', 0.005:0.005:0.5, ...
                ...
                'foldername', fullfile(outfolder, 'results'), 'numpoints', 1000000, ...
                'parameters', [], 'savelength', 5000, ...
                'system_type', 'supercritical_hopf_radius_(strogatz)_brownian', ...
                'tmax', 1000, 'T', 500, 'save_cp_split', save_cp_split, ...
                'randomise', 0, 'rngseed', 28012024, 'vocal', 1);
        ...
        case 'quadratic_potential'
            inputs = make_input_struct(0, 'cp_range', -1:0.01:0, 'etarange', 0.01:0.01:1, ...
                ...
                'foldername', fullfile(outfolder, 'results'), 'numpoints', 1000000, ...
                'parameters', [], 'savelength', 5000, ...
                'system_type', 'quadratic_potential', ...
                'tmax', 1000, 'T', 500, 'save_cp_split', save_cp_split, ...
                'randomise', 0, 'rngseed', 17062020, 'vocal', 1);

        case 'saddle_node'
            inputs = make_input_struct(0, 'cp_range', -2:0.01:-1, 'etarange', 0.01:0.01:1, ...
                'bifurcation_point', 0, 'initial_conditions', 0, ...
        ...
        case 'subcritical_hopf_radius'
            inputs = make_input_struct(0, 'cp_range', -2:0.01:-1, 'etarange', 0.0025:0.0025:0.25, ...
                'bifurcation_point', 0, 'initial_conditions', 0, ...
                'foldername', fullfile(outfolder, 'results'), 'numpoints', 100000, ...
                'parameters', [], 'savelength', 5000, ...
                'system_type', 'subcritical_hopf_radius', ...
                'tmax', 100, 'T', 50, 'save_cp_split', save_cp_split, ...
                'randomise', 0, 'rngseed', 2906202, 'vocal', 1, 'criteria', "max(abs(rout), [], 2)' < 3.*sqrt(-cp_range)", 'maxAttempts', 1000);
